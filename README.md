...
---
## 🚀 Key Features
- Role-based experience – separate dashboards for Donors & Recipients  
- Real-time blood request search (filter by city, blood group, name)  
- Smart donor discovery for recipients (city + blood group filters)  
- Secure Firebase Authentication (Email/Password)  
- Complete profile management with secure password change  
- Dark Mode & Light Mode (system adaptive + manual toggle)  
- Premium "Lavish Red" color scheme with Poppins typography  
- Smooth drawer navigation (Home, Profile, Settings, Logout)  
- Password visibility toggle & modern form validation  
- Fully responsive and offline-first design  

---
### 🔐 Role-Based Access
- **Donors** → View & respond to blood requests.  
- **Recipients** → Quickly find available donors.

### 🔎 Smart, Real-Time Search
- **Donors** can filter requests by:
  - Name  
  - City  
  - Blood Group  
- **Recipients** can search donors instantly based on:
  - City  
  - Blood Group  

### 👤 Secure Account Management
- Update profile: Name, Username  
- Secure password change with Firebase re-authentication  
- Persistent theme preferences using Provider  

### 🎨 Modern UI/UX
- Elegant “Lavish Red” color theme  
- Clean navigation with Drawer (Home, Profile, Settings, Logout)  
- Smooth animations & toggles  
...
| Navigation          | Drawer + Navigator 2.0              |
